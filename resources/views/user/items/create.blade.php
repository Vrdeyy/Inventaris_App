...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                <h1 class="text-2xl sm:text-3xl font-extrabold text-gray-900 tracking-tight">Tambah Barang Baru</h1>
                <p class="text-gray-500 mt-1">Isi formulir di bawah ini untuk mendaftarkan aset baru.</p>
            </div>
            <a href="{{ route('user.items.index') }}"
                class="group flex items-center justify-center text-sm font-bold text-gray-500 hover:text-indigo-600 transition-colors bg-white px-4 py-2 rounded-xl shadow-sm border border-gray-100 hover:border-indigo-100 hover:shadow-md w-fit">
        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
            <div class="bg-gray-50/50 px-8 py-4 border-b border-gray-100 flex items-center justify-between">
                ...
                <div class="p-6 sm:p-8">
                    ...
                    <div
                        class="mb-8 p-4 sm:p-6 bg-gray-50 rounded-2xl border border-gray-100 relative group transition-all hover:bg-indigo-50/30 hover:border-indigo-100">
                        <div class="absolute -top-3 left-4">
                            <span
                                class="bg-indigo-600 text-white text-[10px] sm:text-xs font-bold px-3 py-1 rounded-full shadow-md uppercase tracking-wide">📦
                                Detail Kondisi</span>
                        </div>
                        ...
                        <!-- Total Calculated -->
                        <div
                            class="mt-6 flex flex-col sm:flex-row items-center justify-between p-4 bg-indigo-600 rounded-xl text-white shadow-lg shadow-indigo-200 gap-2">
                            <span class="text-sm font-bold uppercase tracking-wider opacity-80 text-center sm:text-left">Total Unit Barang:</span>
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-end gap-3 pt-6 border-t border-gray-100">
                        <button type="button" onclick="window.history.back()"
                            class="w-full sm:w-auto px-6 py-3 rounded-xl text-sm font-bold text-gray-500 hover:text-gray-700 hover:bg-gray-50 transition-all">Batal</button>
                        <button type="submit"
                            class="w-full sm:w-auto px-8 py-3 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white rounded-xl hover:shadow-lg hover:shadow-indigo-300 hover:-translate-y-0.5 transition-all duration-300 font-bold flex items-center justify-center">
